...
const ProductItem: React.FC<ProductItemProps> = ({ product, setEditingProduct, handleAddSale }) => {
	return (
		<div
			key={product.id}
			className={`product-item ${product.amount === 0 ? 'product-item__empty' : ''}`}
		>
			...
			<div className='product-item-details'>
				...
				<button
					onClick={() => setEditingProduct({ product: { ...product, amount: 1 }, type: 'sale' })}
